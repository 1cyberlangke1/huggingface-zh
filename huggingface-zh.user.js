  ...
  I18N["zh-CN"] = {
    ...
    public: {
      static: {
        ...
        // 数据集查看器不可用提示
        "The dataset viewer is not available because its heuristics could not detect any":
          "数据集查看器不可用，因为其启发式规则未能检测到任何",
        ...
        // YAML 元数据警告
        "YAML Metadata Warning:": "YAML 元数据警告：",
        ...
        "Serve embeddings models with TEI optimized toolkit": "使用 TEI 优化工具包服务嵌入模型",
        ...
        "Create and deploy agentic RL execution environments": "创建和部署智能体 RL 执行环境",
        ...
        "Open source chat frontend powering HuggingChat": "驱动 HuggingChat 的开源聊天前端",
        "Create custom Leaderboards on Hugging Face": "在 Hugging Face 上创建自定义排行榜",
        "Collaboration tool for building high-quality datasets": "构建高质量数据集的协作工具",
        "Framework for synthetic data generation and AI feedback": "合成数据生成和 AI 反馈框架",
        ...
        "Advanced auth policies and repository visibility controls": "高级认证策略和仓库可见性控制",
        ...
        "Automated user management with SCIM provisioning": "通过 SCIM 配置自动管理用户",
        ...
        "to instantly get 20x more included monthly credits!": "立即获取 20 倍月度包含 Credits！",
        ...
        "No connected": "无关联",
        "Public profile": "公开资料",
        'Add "Sign in with HF" to your own applications.': "将「Sign in with HF」添加到你的应用中",
        ...
        "Run Anything": "运行任意任务",
        "Pay-as-you-go": "按需付费",
        "Learn more about Hugging Face Jobs by reading the":
          "通过阅读以下内容了解更多关于 Hugging Face Jobs 的信息",
        documentation: "文档",
        "command:": "命令：",
        ...
        "Interact with discussions / Open PRs on external repos": "参与外部仓库的讨论/开启 PR",
        ...
        "Manage your notification inbox (delete, mark as read)": "管理通知收件箱（删除、标为已读）",
        ...
        "Interact with discussions / Open pull requests on selected repos":
          "参与选定仓库的讨论/开启 PR",
        "Write access to contents/settings of selected repos": "写入选定仓库的内容/设置",
        ...
        "Make calls to Inference Providers on behalf of the selected organizations":
          "代表选定组织调用推理供应商",
        "Make calls to the organization's Inference Endpoints": "调用组织的推理端点",
        "Manage the organization's Inference Endpoints": "管理组织的推理端点",
        "Read access to organizations settings": "读取组织设置",
        "Write access to organizations settings / member management": "写入组织设置/成员管理",
        "Read access to all collections in selected organizations": "读取选定组织中的所有收藏集",
        "Write access to all collections in selected organizations": "写入选定组织中的所有收藏集",
        "Write access to resource groups in selected organizations": "写入选定组织中的资源组",
        ...
        "Start and manage Jobs in selected organizations.": "在选定组织中启动作业",
        ...
        repositories: "仓库",
        you: "你",
        "Repo Discussions you're participating in or mentioned in": "你参与或被提及的仓库讨论",
        ...
        "Secret(s) detected in the code of one of your repos": "在你的仓库代码中检测到机密",
        ...
        "Remove embedded images generated by Gradio Spaces": "移除 Gradio Spaces 生成的嵌入图片",
        "Dynamically call MCP Spaces at runtime": "在运行时动态调用 MCP 应用空间",
        "Run, monitor and schedule jobs on Hugging Face infrastructure":
          "在 Hugging Face 基础设施上运行、监控和调度作业",
        "Upload and write files to Repos and Buckets": "上传和写入文件到仓库和存储桶",
        ...
        "Find ML Research Papers via natural language queries": "通过自然语言查询查找 ML 研究论文",
        "Find the best AI Apps via natural language queries": "通过自然语言查询查找最佳 AI 应用",
        ...
        "Features Preview: Get exclusive early access to upcoming features":
          "功能预览：独占提前体验即将推出的功能",
        "PRO Badge: Show your support on your profile": "PRO 徽章：在你的个人主页展示你的支持",
        ...
        "Drag images here or click to browse your computer.": "将图片拖到此处，或点击浏览你的电脑",
        ...
        "Start discussing with the repository author(s) and the community.":
          "开始与仓库作者和社区讨论。",
        "Make things better": "做出改进",
        "Start the discussion": "开始讨论",
        "Be the first to open a discussion on this repository": "成为第一个在此仓库发起讨论的人",
        "Be the first to open a pull request on this repository":
          "成为第一个在此仓库发起拉取请求的人",
        "Metadata UI": "元数据编辑",
        "Commit changes": "提交更改",
        ...
        "Allow CI/CD workflows to push to this repo without long-lived tokens.":
          "允许 CI/CD 工作流无需长期令牌即可推送到此仓库。",
        ...
        "Anyone on the internet can see this model. Only you can commit.":
          "互联网上的任何人都可以查看此模型。只有你可以提交。",
      ...
      regexp: [
        ...
        [
          /^You have consumed \$([\d.]+) out of your \$([\d.]+) included credits\.$/,
          "已使用 $1 / $2 Credits",
        ],
        ...
        [/^of ([\d.]+ [kMGTP]?B)$/, "/ $1"],
        [
          /^You have a total of ([\d.]+) TFLOPS of computing power\.$/,
          "你总共拥有 $1 TFLOPS 的计算能力",
        ],
        [
          /^Access to (model|dataset) .+ is restricted and you are not in the authorized list\. Visit$/,
          "访问 $1 受限，你不在授权列表中。请访问 ",
        ],
        [
          /^The task_categories "(.+?)" is not in the official list: (.+)$/,
          '任务类别 "$1" 不在官方列表中：$2',
        ],
      ],
